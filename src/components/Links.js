...
function Links() {
  return (
    <section className='links flex column align-center full-width'>
      <Link id='' name='My Twitter Link' link='https://twitter.com/ronniiii_i' />
      <Link id='btn__zuri' name='Zuri Team' link='https://training.zuri.team/' />
      <Link id='books' name='Zuri Books' link='http://books.zuri.team/' />
      <Link id='book__python' name='Python Books' link='https://books.zuri.team/python-for-beginners?ref_id=Roni' />
